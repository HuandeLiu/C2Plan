...
RPLAN_PATH = "../RPLAN_dataset/dataset/floorplan_dataset"
...
def main(limit: int, max_processes: int):
    ...
    for rplan_id in tqdm(todo_ids, smoothing=50/len(todo_ids)):
        command = f'python raster_to_json.py --path {RPLAN_PATH}/{rplan_id}.png || (touch failed_rplan_json/{rplan_id} && false)'
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--max_processes", type=int, default=16)
